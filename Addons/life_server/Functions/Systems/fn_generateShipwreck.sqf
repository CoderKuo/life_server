...
_schiffsw_time_interval = [0.5,3.25]; //Time given in hours, this is the interval in which the shipwreck should take spawn
schiffsw_loot_array = [["goldbar",25],["platinumr",40],["silverr",50]];
...
if (schiffsw_time_min>=schiffsw_time_max || count schiffsw_loot_array < schiffsw_loot_amount) exitWith {schiffsw_enable=false;};
...
// schiffsw STARTEN
[[3,"<t size='1.4'><t color='#A5DF00'>SHIPWRECK</t></t><br/><br/><t size='1'>A sunken ship has been located! It may contain valuable items, it has been marked on your map!</t>",false,[]],"OEC_fnc_broadcast",nil,false] spawn OEC_fnc_MP;
...
_dasWrack setVariable ["trunk_in_use","",true];
_dasWrack setVariable ["opened",false,true];
schiffwoffen = false;

waitUntil {schiffwoffen};
...
while {_lootAmount>0} do {
	...
	_lootArrayFinal pushBack _lootTempToAdd;
};
...
[[3,"<t size='1.4'><t color='#A5DF00'>SHIPWRECK</t></t><br/><br/><t size='1'>The shipwreck has been successfully looted!</t>",false,[]],"OEC_fnc_broadcast",nil,false] spawn OEC_fnc_MP;